...
const teacherNav = [
  ...
  { title: 'Attendance', url: '/teacher/attendance', icon: ClipboardList },
  { title: 'Grades', url: '/teacher/grades', icon: Trophy },
];
              ...
              {navItems.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild tooltip={item.title}>
                    <NavLink
                      to={item.url}
                      end={item.url === '/admin' || item.url === '/teacher' || item.url === '/student'}
